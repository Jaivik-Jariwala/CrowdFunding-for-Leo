...
import { I as Img, M as ModalTitle, a as ModalDescription, F as FormFieldWithIconButton, i as isMobile, j as fadeInAnimation, k as Skeleton, H as HelperLink, f as useSetIsWalletModalOpen, l as SetModalConfigCtx, u as useIsHeadlessWallet, G as GetStartedScreen, n as ModalConfigCtx, e as useIsWalletModalOpen, b as HeadlessConnectUI, o as WalletSelector, p as WalletUIStatesProvider, d as defaultWallets } from './headlessConnectUI-cd65fc5e.browser.esm.js';
...
const ModelViewer = /* @__PURE__ */lazy(() => import('./ModelViewer-5e1927a6.browser.esm.js'));
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./headlessConnectUI-cd65fc5e.browser.esm.js').then(function (n) { return n.r; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./headlessConnectUI-cd65fc5e.browser.esm.js').then(function (n) { return n.q; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-5e29b8b4.browser.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./headlessConnectUI-cd65fc5e.browser.esm.js').then(function (n) { return n.s; });
