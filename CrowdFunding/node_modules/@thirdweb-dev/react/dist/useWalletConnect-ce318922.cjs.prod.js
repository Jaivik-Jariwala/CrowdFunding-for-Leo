...
var coinbaseWallet = require('./headlessConnectUI-4596c8a4.cjs.prod.js');
...
const defaultChainIcon = /* @__PURE__ */reactCore.resolveIpfsUri("ipfs://QmcxZHpyJa8T4i63xqjPYrZ6tKrt55tZJpbXcjSDKuKaf9/ethereum/512.png");
...
const ModelViewer = /* @__PURE__ */React.lazy(() => Promise.resolve().then(function () { return require('./ModelViewer-5bb544aa.cjs.prod.js'); }));
...
function useMetamask() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-4596c8a4.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-4596c8a4.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-e45512fe.cjs.prod.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-4596c8a4.cjs.prod.js'); }).then(function (n) { return n.walletConnectV1$1; });
