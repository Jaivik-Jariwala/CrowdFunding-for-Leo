import { _ as _defineProperty, c as DEFAULT_QUERY_ALL_COUNT } from './QueryParams-ca1fafc2.browser.esm.js';
import { db as ContractWrapper, d4 as buildTransactionFunction, e as AbiSchema, ag as ContractMetadata, dq as MarketplaceContractSchema, a$ as ContractAppURI, ah as ContractRoles, af as ContractEncoder, aP as GasCostEstimator, aQ as ContractEvents, aS as ContractPlatformFee, aR as ContractInterceptor, bw as ListingNotFoundError, bH as getRoleHash, d5 as mapOffer, aV as Transaction, dr as MARKETPLACE_CONTRACT_ROLES, b7 as isNativeToken, cC as NATIVE_TOKENS } from './contract-publisher-822c976b.browser.esm.js';
import { M as MarketplaceDirect, a as MarketplaceAuction, L as ListingType } from './marketplace-auction-547b8af9.browser.esm.js';
...
class Marketplace {
  ...
  constructor(network, address, storage) {
     ...
     * ```
     */
    _defineProperty(this, "makeOffer", /* @__PURE__ */buildTransactionFunction(async (listingId, pricePerToken, quantity) => {
      const listing = await this.contractWrapper.readContract.listings(listingId);
      if (listing.listingId.toString() !== listingId.toString()) {
        throw new ListingNotFoundError(this.getAddress(), listingId.toString());
      }
     ...
     */
    _defineProperty(this, "setBidBufferBps", /* @__PURE__ */buildTransactionFunction(async bufferBps => {
     ...
     */
    _defineProperty(this, "setTimeBufferInSeconds", /* @__PURE__ */buildTransactionFunction(async bufferInSeconds => {
      await this.roles.verify(["admin"], await this.contractWrapper.getSignerAddress());
     ...
     */
    _defineProperty(this, "allowListingFromSpecificAssetOnly", /* @__PURE__ */buildTransactionFunction(async contractAddress => {
      const encoded = [];
     ...
     */
    _defineProperty(this, "allowListingFromAnyAsset", /* @__PURE__ */buildTransactionFunction(async () => {
      const encoded = [];
      const members = await this.roles.get("asset");
...
_defineProperty(Marketplace, "contractRoles", MARKETPLACE_CONTRACT_ROLES);
