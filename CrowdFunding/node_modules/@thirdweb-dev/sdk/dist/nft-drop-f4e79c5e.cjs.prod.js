...
var erc721Standard = require('./erc-721-standard-64f6175c.cjs.prod.js');
var thirdwebCheckout = require('./thirdweb-checkout-739d8162.cjs.prod.js');
...
class NFTDrop extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new contractPublisher.ContractWrapper(network, address, abi, _options);
     ...
     */
    QueryParams._defineProperty(this, "createBatch", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (metadatas, options) => {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async function (destinationAddress, quantity) {
     ...
     * @returns - an array of results containing the id of the token claimed, the transaction receipt and a promise to optionally fetch the nft metadata
     */
    QueryParams._defineProperty(this, "claim", /* @__PURE__ */contractPublisher.buildTransactionFunction(async function (quantity) {
     ...
     *
     */
    QueryParams._defineProperty(this, "burn", /* @__PURE__ */contractPublisher.buildTransactionFunction(async tokenId => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (to, tokenId) => {
     ...
     * @internal
     */
    QueryParams._defineProperty(this, "setApprovalForToken", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (operator, tokenId) => {
...
QueryParams._defineProperty(NFTDrop, "contractRoles", contractPublisher.NFT_BASE_CONTRACT_ROLES);
