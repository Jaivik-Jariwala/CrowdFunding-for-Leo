...
class Vote {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "propose", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (description, executions) => {
      if (!executions) {
        executions = [{
     ...
     */
    QueryParams._defineProperty(this, "vote", /* @__PURE__ */contractPublisher.buildTransactionFunction(async function (proposalId, voteType) {
     ...
     */
    QueryParams._defineProperty(this, "execute", /* @__PURE__ */contractPublisher.buildTransactionFunction(async proposalId => {
