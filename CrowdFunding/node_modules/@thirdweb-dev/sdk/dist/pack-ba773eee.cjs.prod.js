...
var erc1155Standard = require('./erc-1155-standard-c027b6f3.cjs.prod.js');
...
var zod = require('zod');
var hasERC20Allowance = require('./hasERC20Allowance-eb36400c.cjs.prod.js');
require('bn.js');
...
class PackVRF {
  constructor(network, address, storage, options, chainId) {
    var _this = this;
    let contractWrapper = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : new contractPublisher.ContractWrapper(network, address, IPackVRFAbi__default["default"], options);
    QueryParams._defineProperty(this, "featureName", contractPublisher.FEATURE_PACK_VRF.name);
     ...
     * @twfeature PackVRF
     */
    QueryParams._defineProperty(this, "open", /* @__PURE__ */contractPublisher.buildTransactionFunction(async function (tokenId) {
     ...
     * @twfeature PackVRF
     */
    QueryParams._defineProperty(this, "claimRewards", /* @__PURE__ */contractPublisher.buildTransactionFunction(async function () {
  ...
  getLinkContract() {
    ...
    const contract = new contractPublisher.ContractWrapper(this.contractWrapper.getSignerOrProvider(), linkAddress, ERC20Abi__default["default"], this.contractWrapper.options);
...
class Pack extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, address, storage) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "create", /* @__PURE__ */contractPublisher.buildTransactionFunction(async metadataWithRewards => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "addPackContents", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (packId, packContents) => {
      const signerAddress = await this.contractWrapper.getSignerAddress();
     ...
     * ```
     */
    QueryParams._defineProperty(this, "createTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (to, metadataWithRewards) => {
...
QueryParams._defineProperty(Pack, "contractRoles", contractPublisher.PACK_CONTRACT_ROLES);
