...
import { db as ContractWrapper, d4 as buildTransactionFunction, e as AbiSchema, ag as ContractMetadata, dz as DropErc721ContractSchema, a$ as ContractAppURI, ah as ContractRoles, ai as ContractRoyalty, aj as ContractPrimarySale, al as DropClaimConditions, af as ContractEncoder, aP as GasCostEstimator, aQ as ContractEvents, aS as ContractPlatformFee, ak as DelayedReveal, dA as FEATURE_NFT_REVEALABLE, aR as ContractInterceptor, aU as ContractOwner, bH as getRoleHash, aV as Transaction, dn as NFT_BASE_CONTRACT_ROLES } from './contract-publisher-822c976b.browser.esm.js';
import { S as StandardErc721 } from './erc-721-standard-45202548.browser.esm.js';
import { a as PaperCheckout } from './thirdweb-checkout-c6e2451f.browser.esm.js';
...
class NFTDrop extends StandardErc721 {
  ...
  constructor(network, address, storage) {
     ...
     */
    _defineProperty(this, "claimTo", /* @__PURE__ */buildTransactionFunction(async function (destinationAddress, quantity) {
     ...
     * @returns - an array of results containing the id of the token claimed, the transaction receipt and a promise to optionally fetch the nft metadata
     */
    _defineProperty(this, "claim", /* @__PURE__ */buildTransactionFunction(async function (quantity) {
