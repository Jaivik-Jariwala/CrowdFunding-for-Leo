...
class Multiwrap extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "wrap", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (contents, wrappedTokenMetadata, recipientAddress) => {
     ...
     */
    QueryParams._defineProperty(this, "unwrap", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (wrappedTokenId, recipientAddress) => {
      const recipient = await contractPublisher.resolveAddress(recipientAddress ? recipientAddress : await this.contractWrapper.getSignerAddress());
      return contractPublisher.Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "unwrap",
...
QueryParams._defineProperty(Multiwrap, "contractRoles", contractPublisher.MULTIWRAP_CONTRACT_ROLES);
