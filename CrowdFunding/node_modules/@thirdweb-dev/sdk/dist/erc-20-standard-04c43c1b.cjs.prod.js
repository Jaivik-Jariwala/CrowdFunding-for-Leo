...
class StandardErc20 {
  ...
  constructor(contractWrapper, storage, chainId) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transferFrom", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (from, to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "setAllowance", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (spender, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transferBatch", /* @__PURE__ */contractPublisher.buildTransactionFunction(async args => {
