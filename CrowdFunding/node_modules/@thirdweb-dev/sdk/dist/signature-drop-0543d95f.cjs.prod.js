...
class SignatureDrop extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (destinationAddress, quantity, options) => {
     ...
     * @returns - an array of results containing the id of the token claimed, the transaction receipt and a promise to optionally fetch the nft metadata
     */
    QueryParams._defineProperty(this, "claim", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (quantity, options) => {
...
QueryParams._defineProperty(SignatureDrop, "contractRoles", contractPublisher.NFT_BASE_CONTRACT_ROLES);
