import { _ as _defineProperty } from './QueryParams-ca1fafc2.browser.esm.js';
import { db as ContractWrapper, d4 as buildTransactionFunction, e as AbiSchema, ag as ContractMetadata, dy as TokenErc721ContractSchema, a$ as ContractAppURI, ah as ContractRoles, ai as ContractRoyalty, aj as ContractPrimarySale, af as ContractEncoder, aP as GasCostEstimator, aQ as ContractEvents, aS as ContractPlatformFee, aR as ContractInterceptor, aD as Erc721WithQuantitySignatureMintable, aU as ContractOwner, bH as getRoleHash, aV as Transaction, dn as NFT_BASE_CONTRACT_ROLES } from './contract-publisher-822c976b.browser.esm.js';
...
class NFTCollection extends StandardErc721 {
  ...
  constructor(network, address, storage) {
     ...
     * ```
     */
    _defineProperty(this, "mintTo", /* @__PURE__ */buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    _defineProperty(this, "mintBatch", /* @__PURE__ */buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    _defineProperty(this, "mintBatchTo", /* @__PURE__ */buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    _defineProperty(this, "burn", /* @__PURE__ */buildTransactionFunction(tokenId => {
...
_defineProperty(NFTCollection, "contractRoles", NFT_BASE_CONTRACT_ROLES);
