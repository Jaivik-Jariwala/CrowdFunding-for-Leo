import { _ as _defineProperty, e as QueryAllParamsSchema, F as FileOrBufferOrStringSchema, P as PercentSchema, A as AmountSchema, a as BasisPointsSchema, Q as QuantitySchema, g as getRpcUrl, b as CommonNFTInput } from './QueryParams-ca1fafc2.browser.esm.js';
import { z } from 'zod';
import { PublicKey, Keypair, clusterApiUrl, Connection } from '@solana/web3.js';
import { token, findMasterEditionV2Pda, toNftOriginalEdition, toOriginalEditionAccount, GmaBuilder, toMetadata, toMetadataAccount, guestIdentity, amount, SOL, isKeypairSigner, keypairIdentity, isIdentitySigner, walletAdapterIdentity, toBigNumber, sol, TransactionBuilder, getSignerHistogram, toDateTime, findCandyMachineV2CreatorPda, resolveClusterFromConnection, Pda, TokenGpaBuilder, Metaplex } from '@metaplex-foundation/js';
import { TokenStandard, createCreateMetadataAccountV3Instruction } from '@metaplex-foundation/mpl-token-metadata';
 ...
 * @internal
 */
const CreatorInputSchema = /* @__PURE__ */(() => z.object({
  address: z.string(),
  share: PercentSchema,
 ...
 * @internal
 */
const CurrencyValueSchema = /* @__PURE__ */(() => z.object({
  value: z.string(),
 ...
 * @internal
 */
const NFTDropInitialConditionsInputSchema = /* @__PURE__ */z.object({
...
const NFTDropUpdatableConditionsInputSchema = /* @__PURE__ */(() => z.object({
 ...
 * @internal
 */
const NFTDropUpdatableConditionsOutputSchema = /* @__PURE__ */(() => z.object({
