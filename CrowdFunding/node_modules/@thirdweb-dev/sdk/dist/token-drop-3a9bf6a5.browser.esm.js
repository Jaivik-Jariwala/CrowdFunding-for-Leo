...
import { db as ContractWrapper, d4 as buildTransactionFunction, e as AbiSchema, ag as ContractMetadata, dG as DropErc20ContractSchema, a$ as ContractAppURI, ah as ContractRoles, af as ContractEncoder, aP as GasCostEstimator, aQ as ContractEvents, aj as ContractPrimarySale, aS as ContractPlatformFee, aR as ContractInterceptor, al as DropClaimConditions, cq as resolveAddress, bH as getRoleHash, aV as Transaction, dH as TOKEN_DROP_CONTRACT_ROLES } from './contract-publisher-822c976b.browser.esm.js';
import { S as StandardErc20 } from './erc-20-standard-588ba353.browser.esm.js';
...
class TokenDrop extends StandardErc20 {
  ...
  constructor(network, address, storage) {
     ...
     */
    _defineProperty(this, "claim", /* @__PURE__ */buildTransactionFunction(async function (amount) {
     ...
     */
    _defineProperty(this, "claimTo", /* @__PURE__ */buildTransactionFunction(async function (destinationAddress, amount) {
     ...
     * ```
     */
    _defineProperty(this, "burnTokens", /* @__PURE__ */buildTransactionFunction(async amount => {
