...
import { db as ContractWrapper, d4 as buildTransactionFunction, e as AbiSchema, ag as ContractMetadata, dE as SplitsContractSchema, a$ as ContractAppURI, ah as ContractRoles, af as ContractEncoder, aP as GasCostEstimator, aQ as ContractEvents, aR as ContractInterceptor, cq as resolveAddress, bb as fetchCurrencyValue, aV as Transaction, dF as ADMIN_ROLE } from './contract-publisher-822c976b.browser.esm.js';
...
class Split {
  ...
  constructor(network, address, storage) {
     ...
     */
    _defineProperty(this, "withdraw", /* @__PURE__ */buildTransactionFunction(async walletAddress => {
     ...
     */
    _defineProperty(this, "withdrawToken", /* @__PURE__ */buildTransactionFunction(async (walletAddress, tokenAddress) => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
     ...
     * ```
     */
    _defineProperty(this, "distribute", /* @__PURE__ */buildTransactionFunction(async () => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "distribute()",
        args: []
     ...
     * @param tokenAddress - The address of the currency contract to distribute funds
     */
    _defineProperty(this, "distributeToken", /* @__PURE__ */buildTransactionFunction(async tokenAddress => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
...
_defineProperty(Split, "contractRoles", ADMIN_ROLE);
