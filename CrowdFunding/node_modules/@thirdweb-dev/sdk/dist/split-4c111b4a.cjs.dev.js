...
class Split {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "withdraw", /* @__PURE__ */contractPublisher.buildTransactionFunction(async walletAddress => {
     ...
     */
    QueryParams._defineProperty(this, "withdrawToken", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (walletAddress, tokenAddress) => {
      return contractPublisher.Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
     ...
     * ```
     */
    QueryParams._defineProperty(this, "distribute", /* @__PURE__ */contractPublisher.buildTransactionFunction(async () => {
      return contractPublisher.Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "distribute()",
        args: []
     ...
     * @param tokenAddress - The address of the currency contract to distribute funds
     */
    QueryParams._defineProperty(this, "distributeToken", /* @__PURE__ */contractPublisher.buildTransactionFunction(async tokenAddress => {
      return contractPublisher.Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
...
QueryParams._defineProperty(Split, "contractRoles", contractPublisher.ADMIN_ROLE);
