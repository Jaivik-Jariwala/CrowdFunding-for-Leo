...
var erc20History = require('./erc-20-history-b8d65ee9.cjs.prod.js');
var erc20Standard = require('./erc-20-standard-04c43c1b.cjs.prod.js');
...
class Token extends erc20Standard.StandardErc20 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "mint", /* @__PURE__ */contractPublisher.buildTransactionFunction(async amount => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async args => {
     ...
     * @alpha
     */
    QueryParams._defineProperty(this, "delegateTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async delegateeAddress => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", /* @__PURE__ */contractPublisher.buildTransactionFunction(amount => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnFrom", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (holder, amount) => {
...
QueryParams._defineProperty(Token, "contractRoles", contractPublisher.NFT_BASE_CONTRACT_ROLES);
