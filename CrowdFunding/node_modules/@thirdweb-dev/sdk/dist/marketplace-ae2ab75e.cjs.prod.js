...
var marketplaceAuction = require('./marketplace-auction-dd910a2e.cjs.prod.js');
...
class Marketplace {
  ...
  constructor(network, address, storage) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "makeOffer", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (listingId, pricePerToken, quantity) => {
      const listing = await this.contractWrapper.readContract.listings(listingId);
      if (listing.listingId.toString() !== listingId.toString()) {
        throw new contractPublisher.ListingNotFoundError(this.getAddress(), listingId.toString());
      }
     ...
     */
    QueryParams._defineProperty(this, "setBidBufferBps", /* @__PURE__ */contractPublisher.buildTransactionFunction(async bufferBps => {
     ...
     */
    QueryParams._defineProperty(this, "setTimeBufferInSeconds", /* @__PURE__ */contractPublisher.buildTransactionFunction(async bufferInSeconds => {
      await this.roles.verify(["admin"], await this.contractWrapper.getSignerAddress());
     ...
     */
    QueryParams._defineProperty(this, "allowListingFromSpecificAssetOnly", /* @__PURE__ */contractPublisher.buildTransactionFunction(async contractAddress => {
      const encoded = [];
     ...
     */
    QueryParams._defineProperty(this, "allowListingFromAnyAsset", /* @__PURE__ */contractPublisher.buildTransactionFunction(async () => {
      const encoded = [];
      const members = await this.roles.get("asset");
...
QueryParams._defineProperty(Marketplace, "contractRoles", contractPublisher.MARKETPLACE_CONTRACT_ROLES);
