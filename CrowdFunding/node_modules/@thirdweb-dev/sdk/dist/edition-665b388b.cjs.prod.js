...
class Edition extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new contractPublisher.ContractWrapper(network, address, abi, options);
     ...
     */
    QueryParams._defineProperty(this, "mint", /* @__PURE__ */contractPublisher.buildTransactionFunction(async metadataWithSupply => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (to, metadataWithSupply) => {
     ...
     */
    QueryParams._defineProperty(this, "mintAdditionalSupply", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (tokenId, additionalSupply) => {
     ...
     * @param additionalSupply - the additional amount to mint
     */
    QueryParams._defineProperty(this, "mintAdditionalSupplyTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (to, tokenId, additionalSupply) => {
     ...
     */
    QueryParams._defineProperty(this, "mintBatch", /* @__PURE__ */contractPublisher.buildTransactionFunction(async metadatas => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (to, metadataWithSupply) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (tokenId, amount) => {
...
QueryParams._defineProperty(Edition, "contractRoles", contractPublisher.NFT_BASE_CONTRACT_ROLES);
