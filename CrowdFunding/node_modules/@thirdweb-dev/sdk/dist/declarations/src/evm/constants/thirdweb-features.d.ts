...
export declare const FEATURE_SMART_WALLET_FACTORY: {
    readonly name: "SmartWalletFactory";
    readonly namespace: "smartwallet.factory";
    readonly docLinks: {
        readonly sdk: "sdk.smartWalletFactory";
        readonly contracts: "smartWalletFactory";
    };
    readonly abis: readonly [({
        anonymous: boolean;
        inputs: {
...
export declare const FEATURE_SMART_WALLET: {
    readonly name: "SmartWallet";
    readonly namespace: "smartwallet";
    readonly docLinks: {
        readonly sdk: "";
        readonly contracts: "";
    };
