...
var dropErc1155History = require('./drop-erc1155-history-733541a1.cjs.prod.js');
...
class EditionDrop extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, _address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new contractPublisher.ContractWrapper(network, _address, abi, _options);
     ...
     */
    QueryParams._defineProperty(this, "claimTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async function (destinationAddress, tokenId, quantity) {
     ...
     * @returns - Receipt for the transaction
     */
    QueryParams._defineProperty(this, "claim", /* @__PURE__ */contractPublisher.buildTransactionFunction(async function (tokenId, quantity) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnTokens", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (tokenId, amount) => {
...
QueryParams._defineProperty(EditionDrop, "contractRoles", contractPublisher.NFT_BASE_CONTRACT_ROLES);
