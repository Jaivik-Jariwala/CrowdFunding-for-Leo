...
class NFTCollection extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mint", /* @__PURE__ */contractPublisher.buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatch", /* @__PURE__ */contractPublisher.buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", /* @__PURE__ */contractPublisher.buildTransactionFunction(tokenId => {
...
QueryParams._defineProperty(NFTCollection, "contractRoles", contractPublisher.NFT_BASE_CONTRACT_ROLES);
