...
class TokenDrop extends erc20Standard.StandardErc20 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "claim", /* @__PURE__ */contractPublisher.buildTransactionFunction(async function (amount) {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", /* @__PURE__ */contractPublisher.buildTransactionFunction(async function (destinationAddress, amount) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnTokens", /* @__PURE__ */contractPublisher.buildTransactionFunction(async amount => {
...
QueryParams._defineProperty(TokenDrop, "contractRoles", contractPublisher.TOKEN_DROP_CONTRACT_ROLES);
