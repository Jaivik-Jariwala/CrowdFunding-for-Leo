...
import { AcceptDirectOffer, BuyFromListingParams, ExecuteAuctionSale, MakeBidParams, MakeOfferParams } from "../../types";
 ...
 */
export declare function useCreateDirectListing<TMarketplace extends Marketplace | MarketplaceV3>(contract: RequiredParam<TMarketplace>): UseMutationResult<import("@thirdweb-dev/sdk").TransactionResultWithId<never>, unknown, TMarketplace extends Marketplace ? NewDirectListing : {
 ...
 */
export declare function useCreateAuctionListing<TMarketplace extends Marketplace | MarketplaceV3>(contract: RequiredParam<TMarketplace>): UseMutationResult<import("@thirdweb-dev/sdk").TransactionResultWithId<never>, unknown, TMarketplace extends Marketplace ? NewAuctionListing : {
    tokenId: (string | number | bigint | BigNumber) & (string | number | bigint | BigNumber | undefined);
