...
export interface IAccountFactoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "accountImplementation" | "createAccount" | "getAccountsOfSigner" | "getAddress" | "getSignersOfAccount" | "onSignerAdded" | "onSignerRemoved"): FunctionFragment;
...
export interface IAccountFactory extends BaseContract {
    ...
    functions: {
        ...
        onSignerAdded(signer: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        onSignerRemoved(signer: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    accountImplementation(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        getAddress(adminSigner: string, data: BytesLike, overrides?: CallOverrides): Promise<string>;
        getSignersOfAccount(account: string, overrides?: CallOverrides): Promise<string[]>;
        onSignerAdded(signer: string, overrides?: CallOverrides): Promise<void>;
        onSignerRemoved(signer: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
