...
export interface AirdropERC20Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "addRecipients", values: [IAirdropERC20.AirdropContentStruct[]]): string;
    encodeFunctionData(functionFragment: "airdrop", values: [IAirdropERC20.AirdropContentStruct[]]): string;
...
export interface AirdropERC20 extends BaseContract {
    ...
    functions: {
        ...
        addRecipients(_contents: IAirdropERC20.AirdropContentStruct[], overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        airdrop(_contents: IAirdropERC20.AirdropContentStruct[], overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        getCancelledPaymentIndices(overrides?: CallOverrides): Promise<[IAirdropERC20.CancelledPaymentsStructOutput[]]>;
    ...
    contractType(overrides?: CallOverrides): Promise<string>;
    contractVersion(overrides?: CallOverrides): Promise<number>;
    getAllAirdropPayments(startId: BigNumberish, endId: BigNumberish, overrides?: CallOverrides): Promise<IAirdropERC20.AirdropContentStructOutput[]>;
    getAllAirdropPaymentsFailed(overrides?: CallOverrides): Promise<IAirdropERC20.AirdropContentStructOutput[]>;
    getAllAirdropPaymentsPending(startId: BigNumberish, endId: BigNumberish, overrides?: CallOverrides): Promise<IAirdropERC20.AirdropContentStructOutput[]>;
    getCancelledPaymentIndices(overrides?: CallOverrides): Promise<IAirdropERC20.CancelledPaymentsStructOutput[]>;
    getRoleAdmin(role: BytesLike, overrides?: CallOverrides): Promise<string>;
    getRoleMember(role: BytesLike, index: BigNumberish, overrides?: CallOverrides): Promise<string>;
    getRoleMemberCount(role: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
        addRecipients(_contents: IAirdropERC20.AirdropContentStruct[], overrides?: CallOverrides): Promise<void>;
        airdrop(_contents: IAirdropERC20.AirdropContentStruct[], overrides?: CallOverrides): Promise<void>;
