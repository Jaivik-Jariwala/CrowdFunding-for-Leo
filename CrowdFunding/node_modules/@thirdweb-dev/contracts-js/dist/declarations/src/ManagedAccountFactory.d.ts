...
export interface ManagedAccountFactoryInterface extends utils.Interface {
    functions: {
        ...
        "onSignerAdded(address)": FunctionFragment;
        "onSignerRemoved(address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "accountImplementation" | "addExtension" | "contractURI" | "createAccount" | "defaultExtensionSet" | "getAccountsOfSigner" | "getAddress" | "getAllExtensions" | "getAllFunctionsOfExtension" | "getExtension" | "getExtensionForFunction" | "getExtensionImplementation" | "getImplementationForFunction" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "getSignersOfAccount" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "multicall" | "onSignerAdded" | "onSignerRemoved" | "removeExtension" | "renounceRole" | "revokeRole" | "setContractURI" | "updateExtension"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "onSignerAdded", values: [string]): string;
    encodeFunctionData(functionFragment: "onSignerRemoved", values: [string]): string;
...
export interface ManagedAccountFactory extends BaseContract {
    ...
    functions: {
        ...
        onSignerAdded(_signer: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        onSignerRemoved(_signer: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        onSignerAdded(_signer: string, overrides?: CallOverrides): Promise<void>;
        onSignerRemoved(_signer: string, overrides?: CallOverrides): Promise<void>;
